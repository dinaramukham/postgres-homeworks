...
if __name__=='__main__':
    ...
    with conn.cursor() as curs:
        ...
        for customer in csv_list_customers:
            curs.execute('INSERT INTO employees VALUES (%s, %s, %s)', (
        ...
        for order in csv_list_orders:
            curs.execute('INSERT INTO employees VALUES (%s, %s, %s, %s, %s)', (
    ...
    # conn.commit
    # conn.close()
        for el in data_order:
            print(el)  # вывести все значения таблицы
    # data1=curs.fetchone # одну строчку
    # data2=curs.fetchmany # указать скока строк
    # curs.close # закрыть
